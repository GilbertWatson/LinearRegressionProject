...
#do automated variable selection both forwards and backwards in an attempt to find a starting model, get a liberal number of variables
#exhaustive search takes a long long time with this many variables.
modelsf <- regsubsets(x=xx,nbest=20,nvmax=22,y=fullmodel$model$DRVIC2011_RV.Tuition.and.fees..2010.11,method="forward",really.big=T)
modelsb <- regsubsets(x=xx,nbest=20,nvmax=22,y=fullmodel$model$DRVIC2011_RV.Tuition.and.fees..2010.11,method="backward",really.big=T)
modelss <- regsubsets(x=xx,nbest=20,nvmax=22,y=fullmodel$model$DRVIC2011_RV.Tuition.and.fees..2010.11,method="seqrep",really.big=T)
...
#residual plot
require(ggplot2)
qplot(x=testdata$DRVIC2011_RV.Tuition.and.fees..2010.11,y=lastmodel$residuals,xlab="response",ylab="residuals")
@
